import { sql, sqliteTable, text, integer, real } from 'drizzle-orm/sqlite-core';
...
export const matches = sqliteTable('matches', {
  ...
  agent1Frames: text('agent1_frames').notNull(), // JSON string of frame data
  agent2Frames: text('agent2_frames').notNull(),
  replayData: text('replay_data').notNull(), // JSON string for visualization
